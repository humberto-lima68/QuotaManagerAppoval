...
sap.ui.define([
	...
	return BaseController.extend("exed.com.quaotamanagerapproval.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getView().byId("page").setTitle(" Requests " + "(" + iZusergc + ")");
		...
		executaFiltro: function (iZusergc) {
			...
			var valor = iZusergc;
			var filter = new sap.ui.model.Filter("Zuserid", sap.ui.model.FilterOperator.EQ, valor);
		...
		onSearch: function (oEvent) {
			...
			var filter1 = new sap.ui.model.Filter("Zuserid", sap.ui.model.FilterOperator.EQ, iZusergc);
		...
		_showDetail: function (oItem) {
			...
			var zchave = oItem.getBindingContext().getProperty("Zchave");
			var sku = oItem.getBindingContext().getProperty("ZzbrAtpskp");
			var zuserid = iZusergc;
			this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
			this.getRouter().navTo("DetailAs", {
				Zchave: zchave,
				sku: btoa(JSON.stringify(sku)),
				Zuserid: zuserid
			}, bReplace);
