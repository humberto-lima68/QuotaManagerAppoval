		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Quota Manager - Approval",
									"targetURL": "#QuotaManagerApproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"QuotaManagerApproval-display": {
								"semanticObject": "QuotaManagerApproval",
								"action": "display",
								"description": "Quota Manager - Approval",
								"title": "Quota Manager - Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exed.com.quaotamanagerapproval",
									"url": sap.ui.require.toUrl("exed/com/quaotamanagerapproval")
								}
							}
						}
					}
