sap.ui.define([
	"sap/ui/test/Opa5",
	"exed/com/quaotamanagerapproval/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("exed.com.quaotamanagerapproval.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "exed.com.quaotamanagerapproval",
					async: true
				},
				hash: oOptions.hash,
